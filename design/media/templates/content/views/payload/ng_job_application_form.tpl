...
{* BLOCK form_body *}
    ...
    {form_start($form, $form_parameters)}
        ...
        <div class="form-wrapper">
            ...
            {form_row($form.sender_file_cv.children.value.children.file, hash('ngparams', hash('label', $content.fields.sender_file_cv.name)))}
            {form_row($form.sender_motivation_letter.children.value.children.file, hash('ngparams', hash('label', $content.fields.sender_motivation_letter.name)))}
