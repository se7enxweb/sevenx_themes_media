...
<div {item_params($toolbar_macros, $content, $location)} class="view-type view-type-{$view_type} ng-blog-post vl3  {if $show_details_on_hover}show_details_on_hover{/if}">
