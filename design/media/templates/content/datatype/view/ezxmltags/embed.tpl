{if and( is_set( $object ), $object.class_identifier|eq( 'image' ) )}
    ...
    <div class="align-{$embed_align} ez-embed-type-image{if ne( $classification|trim, '' )} {$classification|wash}{/if}"{if is_set( $object_parameters.id )} id="{$object_parameters.id}"{/if}>
